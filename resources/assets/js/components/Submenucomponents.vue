                ...
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <td>{{mydataObjectinfo.shid}}</td>
                     ...
                     <td>
                         <template v-if="mydataObjectinfo.maincomponent_submenus">	{{mydataObjectinfo.maincomponent_submenus.name}}</template>
...
<option value="">  </option>
<option v-for='data in studentclasses' v-bind:value='data.id'>{{ data.id }}. {{ data.name }}</option>
